...
/**
 * This class represents application, the purpose of creation - to het ability to handle exceptions
...
public class MyApplication extends Application {
    ...
    void handleUncaughtException(final Throwable e) {
        ...
        intent.setAction("ua.com.glady.uacc.SendExceptionActivity"); // see step 5.
